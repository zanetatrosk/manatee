import { Ability, AbilityScore, BaseItem, BasicInfo, Feature, Source, Sourceable } from "./characterForm";
...
export type { CharacterSheet, SheetHeaderInfo, Spellcasting, BaseSkill, Stats, Proficiencies, CharacterInfo, AbilitySheet }